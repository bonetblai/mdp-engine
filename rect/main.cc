...
void usage(ostream &os) {
    os << "usage: rect [--no-colors] [{-r | --request} <request>]* [{-s | --seed} <default-seed>] [{-t | --trials} <num-trials>] <x-dim> <y-dim> [<p>]" << endl;
}
