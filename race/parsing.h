...
public:
  ...
  bool goal_pos( int x, int y ) const { return( (x >= 0) && (x < rows_) && (y >= 0) && (y < cols_) && map_[x*cols_+y] & Goal ); }
  bool valid_pos( int x, int y ) const { return( (x >= 0) && (x < rows_) && (y >= 0) && (y < cols_) && map_[x*cols_+y] & Valid ); }
