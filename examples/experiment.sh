...
(cd binary-search; ./experiment.sh 80 10 iw-bel2 5 3 250 300 >> results.txt)
...
(cd rocksample; ./experiment.sh 8 6 1 10 iw-bel2 5 3 250 300 >> results.txt)
echo rocksample iw-bel3
(cd rocksample; ./experiment.sh 8 6 1 10 iw-bel3 3 1 250 300 >> results.txt)
(cd rocksample; ./experiment.sh 8 6 1 10 iw-bel3 3 2 250 300 >> results.txt)
...
(cd rocksample_original; ./experiment.sh 8 6 10 iw-bel2 5 3 250 300 >> results.txt)
echo rocksample_original iw-bel3
(cd rocksample_original; ./experiment.sh 8 6 10 iw-bel3 3 1 250 300 >> results.txt)
(cd rocksample_original; ./experiment.sh 8 6 10 iw-bel3 3 2 250 300 >> results.txt)
